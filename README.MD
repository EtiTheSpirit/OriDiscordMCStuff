...
- OptiFine
- EnderZoo (Modified)
- Hwyla - Shows the block or entity you are looking at.
- iChunUtil (Necessary Core Package)
- JustEnoughItems - Shows recipes and all blocks in the game. /give is not available so it cannot be used for cheating.
- JourneyMap
- MorePlayerModels
- Morph (Modified)
- The Betweenlands
